      ...
      <nav className="bg-white border-gray-200 border-b dark:bg-gray-900 dark:border-slate-600 text-base">
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto ">
          ...
          <div className={`${hidden ? `hidden` : " "} items-center justify-between w-full md:flex md:w-auto md:order-1`} id="navbar-search">
              ...
              >
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 text-sm rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:placeholder-gray-400"
            ...
            {/* Actor Search (Mobile) */}
            <div className="relative mt-4 md:hidden px-4">
              <form
                onSubmit={(e) => {
                  e.preventDefault();
                  if (actor.trim()) {
